...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 27, 2019 lúc 02:15 PM
...
--
-- Cấu trúc bảng cho bảng `mon_lhp`
--
...
('ma01', 'user1', '1992-10-05', 2, '2019-12-27 08:53:42'),
('ma02', 'user2', '1234566', 1, '2019-12-25 10:00:10'),
('ma03', 'user3', '1999-05-12', 1, '2019-12-27 09:16:49'),
...
--
-- Các ràng buộc cho bảng `mon_lhp`
--
ALTER TABLE `mon_lhp`
