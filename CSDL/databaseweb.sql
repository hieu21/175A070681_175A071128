...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 10, 2020 lúc 07:40 AM
...
('KHGD02', 'Tin', 'A2', '2019-12-30 00:00:00', 'ma03');
...
--
-- Đang đổ dữ liệu cho bảng `lmh_lhp`
--

INSERT INTO `lmh_lhp` (`maLHP`, `maLMH`) VALUES
('LHP01', 'LMH01'),
('LHP02', 'LMH02'),
('LHP03', 'LMH03'),
('LHP04', 'LMH04');
...
('M02', 'Ngôn ngữ lập trình', 'N01'),
('M03', 'Lập trình nâng cao', 'N01'),
('M04', 'Tin học đại cương', 'N01');
