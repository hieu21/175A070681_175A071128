...
<?php
	if (isset($_POST["btn_edit"])) {//name chỗ nút cập nhâtj
        ...
        $sql = 'UPDATE giangvien SET hoTenGV = "'.$Hoten.'", ngaySinh = "'.$Ngaysinh.'", diaChi = "'.$Diachi.'" WHERE maGV = "'.$Magiangvien.'"';
       
		// thực thi câu $sql với biến conn lấy từ file connection.php
		mysqli_query($conn,$sql);
        
		header('Location: TTGV.php');
        ...
        <div class="main">
                ...
                <form action="suaTTGV.php" method="post" >
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="Magiangvien" name="Magiangvien" value="<?php echo $data['maGV']; ?>" readonly >
                    </div>
